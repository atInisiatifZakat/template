...
final class Disclaimer
{
     ...
     */
    private $disclaimers = [
        'Inisiatif Zakat Indonesia terdaftar sebagai lembaga penerbit Bukti Setor Zakat (BSZ) untuk pengurangan penghasilan kena pajak berdasarkan peraturan Dirjen Pajak No. PER-11/PJ/2017.',
